...
func permitSelf(session uintptr, baseObjects *baseObjects, weight uint8) error {
	...
	//
	{
		displayData, err := createWtFwpmDisplayData0("Permit unrestricted outbound traffic for godusevpn service (IPv4)", "")
		if err != nil {
			return wrapErr(err)
		}
	...
	//
	{
		displayData, err := createWtFwpmDisplayData0("Permit unrestricted inbound traffic for godusevpn service (IPv4)", "")
		if err != nil {
			return wrapErr(err)
		}
	...
	//
	{
		displayData, err := createWtFwpmDisplayData0("Permit unrestricted outbound traffic for godusevpn service (IPv6)", "")
		if err != nil {
			return wrapErr(err)
		}
	...
	//
	{
		displayData, err := createWtFwpmDisplayData0("Permit unrestricted inbound traffic for godusevpn service (IPv6)", "")
		if err != nil {
			return wrapErr(err)
		}
