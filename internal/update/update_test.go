...
func TestNewer(t *testing.T) {
	for _, c := range []struct {
		...
		// 同一主版本下的预发布序列:a3 → a4 必须认得出来(以前数字相同就直接判"已是最新",整个 0.6.0-aN 系列都收不到更新)
		{"0.6.0-a4", "0.6.0-a3", true}, {"0.6.0-a3", "0.6.0-a4", false}, {"0.6.0-a3", "0.6.0-a3", false},
		{"0.6.0-a10", "0.6.0-a9", true}, {"0.6.0-a9", "0.6.0-a10", false}, // 纯字典序会把 a10 排在 a9 前面
		{"0.6.0-b1", "0.6.0-a9", true}, {"0.5.4-l1", "0.5.0-l0", true}, {"0.6.1-a1", "0.6.0-a9", true},
		{"0.6.0", "0.6.0-a4", true}, {"0.6.0-a4", "0.6.0", false},
	} {
